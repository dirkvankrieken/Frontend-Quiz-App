...
- How to use Next.js, a React Framework, for my project.
- How to use an UI component from a UI component library, in this case Shadcn.
- How to implement Dark/light theme and toggle in Next.js and code the whole website to react to the theme using TailwindCSS.
